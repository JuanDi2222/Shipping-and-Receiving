...
import { createShipmentPrueba } from "~/server/db/actions";
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
        ...
        <div className="m-28 mt-16 grid gap-4 lg:grid-cols-4">
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>2nd Address</FormLabel>
                <FormControl>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>Description of goods / Reason for shipment</FormLabel>
                <FormControl>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>Project / Time Sheet</FormLabel>
                <HoverCard>
                  <HoverCardTrigger>
                    <Info />
                  </HoverCardTrigger>
        ...
        <div className="m-28 mt-16 grid gap-4 lg:grid-cols-4 ">
                    ...
                    {selectedOption == "Mexico" && (
                      <>
                        <FormItem className="flex items-center space-x-3 space-y-0">
                          ...
                          <FormLabel className="text-xl font-normal">
                            Next Day Delivery for Chihuahua (Other states may vary)
                          </FormLabel>
                        </FormItem>
                      </>
                    )}
          ...
          {selectedOption !== null && (
            <>
              ...
              <span className="text-black text-2xl text-justify inline-flex gap-4"> <BellAlertIcon className="text-red-600 w-20"/> For international shipments other than the US, we will need further confirmation from the destination to prevent returns or delays.</span>
              </div>
              <div>
...
<FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel>Form Feedback</FormLabel>
              <FormControl>
                <Textarea
                  placeholder="Please provide feedback to make a better form"
